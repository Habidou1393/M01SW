    ...
    switch($req_methode)
    {
        ...
        case 'POST' :
            ...
            if(isset($_POST['journal']))
            {
                ...
                $message_journal_lumineux = "<L1><PA><FE><MA><WC><FE>".$_POST['texte'];
                ...
                if($socketUDP!=false)
                {
                    ...
                    $nbOctetsEmis = socket_sendto($socketUDP, $message_journal_lumineux_chiffre, strlen($message_journal_lumineux_chiffre), 0, "172.20.21.158", 4321);
